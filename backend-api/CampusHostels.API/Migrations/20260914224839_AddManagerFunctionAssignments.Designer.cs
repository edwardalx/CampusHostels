...
namespace CampusHostels.API.Migrations
{
    ...
    [Migration("20260914224839_AddManagerFunctionAssignments")]
    partial class AddManagerFunctionAssignments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PropertyUser", b =>
                {
                    ...
                    b.Property<int>("LikedHostelsId")
                        .HasColumnType("integer");

                    b.HasKey("LikedByUsersId", "LikedHostelsId");

                    b.HasIndex("LikedHostelsId");
