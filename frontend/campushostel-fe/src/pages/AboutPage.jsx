  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <p className="text-center mb-10 text-gray-600">
        ...
        make secure payments, and manage their tenancy agreements online.
        We aim to provide a safe and comfortable living environment for all residents.
      </p>

      {/* Tenant Do's */}
      <div className="mb-8">
        <h2 className="text-xl font-semibold mb-3">Tenant Responsibilities (Do's)</h2>
      ...
      {/* Tenant Don'ts */}
      <div className="mb-8">
        <h2 className="text-xl font-semibold mb-3">Tenant Restrictions (Don'ts)</h2>
        <ul className="list-disc ml-6 space-y-2">
      ...
      <div>
        <h2 className="text-xl font-semibold mb-3">Landlord Responsibilities</h2>
        <ul className="list-disc ml-6 space-y-2">
